...
from data_explorer.mpl_interaction import PanAndZoom
from pandas import DataFrame


class ObjectivesScatterCanvas(ExpandingFigureCanvas):
    def __init__(self, objectives: DataFrame, all_variables: DataFrame, all_objectives: DataFrame, selection_callback):
